...
<script type="text/x-handlebars" data-template-name="queue">
    <div class="Queue-Container">
        ...
        <i title="Reinicia os parametros para 0" class="fa fa-refresh" style="cursor:pointer; font-size:25px; position:absolute; right:0; padding:2px" onclick="refreshQueueParameters(this.offsetParent.dataset.idattr)"></i>
    ...
    <div class="Queue-Container-Agent-Client">
        ...
        <div style="width:40%;">
                <b>Ligacoes na Fila:</b><span class="monitor"><b>{{callers.length}}</b></span><br/>
