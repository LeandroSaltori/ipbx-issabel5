...
$html .= '<a href="http://www.prismatelecom.org" target="_blank">IPbx - Prisma Telecom</a> ' . br();
$html .= __('IPbxPrisma') . ' ' . $version . ' ' . __('is licensed under the')
		. '<a href="http://www.gnu.org/copyleft/gpl.html" target="_blank"> GPL</a>' . br();
$html .= 'Copyright&copy; 2006-'.date('Y',time());
