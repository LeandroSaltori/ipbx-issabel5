...
function show_aststats() {
    ...
    $out .= "<h3 class=\"ui-widget-header ui-corner-all has-text-light\">".sprintf(__("Estatisticas"), DASHBOARD_ISSABELPBX_BRAND)."</h3>";
    ...
    $out .= "<br/><h4>".sprintf(__("Conexoes"), DASHBOARD_ISSABELPBX_BRAND)."</h4>";
...
function show_syslog(&$md5_checksum) {
    ...
    $out .= "<h3 class=\"ui-widget-header ui-corner-all has-text-light\">".sprintf(__("Avisos"), DASHBOARD_ISSABELPBX_BRAND)."</h3>";
...
if (!$quietmode) {
    ...
    <div class='content'>
    <h2><?php echo sprintf(__("IPbx Prisma - Status do sistema"), DASHBOARD_ISSABELPBX_BRAND);?></h2>
    <div id="dashboard">
    <?php
